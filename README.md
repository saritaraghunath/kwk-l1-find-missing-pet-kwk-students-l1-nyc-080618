...
BUT WOW that's a lot of steps. Programming is all about making things simple, so there has to be a better way. In fact, we can actually combine all the steps into one short line:https://learn.co/tracks/kwk-student-lessons-l1/navigating-the-command-line/test/kwk-l1-find-missing-pet#
